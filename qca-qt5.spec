...
Version  : 2.3.0
Release  : 8
URL      : https://github.com/KDE/qca/archive/v2.3.0/qca-2.3.0.tar.gz
Source0  : https://github.com/KDE/qca/archive/v2.3.0/qca-2.3.0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1591712399
mkdir -p clr-build
pushd clr-build
