...
Version  : 2.2.0
Release  : 4
URL      : https://github.com/KDE/qca/archive/v2.2.0/qca-2.2.0.tar.gz
Source0  : https://github.com/KDE/qca/archive/v2.2.0/qca-2.2.0.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1554822761
mkdir -p clr-build
pushd clr-build
%cmake ..
make  %{?_smp_mflags}
